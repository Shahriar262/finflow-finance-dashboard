      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-2xl bg-indigo-50 dark:bg-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-500/30">
              <Lightbulb size={22} />
            </div>
            <div>
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-50 tracking-tight transition-colors">
                Smart Analysis
              </h3>
              <p className="text-[10px] font-black text-indigo-600 dark:text-indigo-500 uppercase tracking-widest">
                FinFlow AI Engine
              </p>
            </div>
          </div>
        ...
        <div className="space-y-5 flex-grow">
          ...
          <div className="p-5 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 backdrop-blur-sm hover:bg-slate-100 dark:hover:bg-white/10 transition-colors">
            ...
            <p className="text-[14px] leading-relaxed text-slate-700 dark:text-slate-200 font-medium transition-colors">
              You've spent the most on{" "}
              <span className="text-indigo-600 dark:text-white font-bold underline decoration-indigo-500 underline-offset-4">
                {insightData.topCat}
              </span>
          ...
          {/* Card Item - Savings Goal */}
          <div className="p-5 rounded-2xl bg-emerald-50/50 dark:bg-white/5 border border-emerald-100/50 dark:border-white/5 backdrop-blur-sm hover:bg-emerald-50 dark:hover:bg-white/10 transition-colors">
            <div className="flex items-center gap-3 mb-3">
              <Target size={16} className="text-emerald-600 dark:text-emerald-400" />
              <p className="text-[11px] font-bold uppercase tracking-wider text-emerald-700/70 dark:text-slate-400">
                Savings Goal
              </p>
            </div>
            <p className="text-[14px] leading-relaxed text-slate-700 dark:text-slate-200 font-medium transition-colors">
        ...
        {/* Action Button */}
        <button className="w-full mt-10 py-4 bg-indigo-600 hover:bg-indigo-700 dark:hover:bg-indigo-500 text-white rounded-2xl text-[14px] font-bold shadow-lg shadow-indigo-200 dark:shadow-indigo-900/40 flex items-center justify-center gap-2 transition-all active:scale-95 group/btn">
