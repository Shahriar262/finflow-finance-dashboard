  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center p-4 sticky top-0 z-40 transition-colors duration-300">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link to="/" className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white tracking-tight">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        {/* Dark Mode Toggle */}
        <button onClick={toggleTheme} className="p-2.5 cursor-pointer rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all">
          {theme === "light" ? <Moon size={20} /> : <Sun size={20} />}
        </button>

        {/* Bell Icon */}
        <button className="p-2.5 text-slate-600 cursor-pointer dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl transition-all relative">
          <Bell size={20} />
        ...
        <div className="relative">
          ...
          >
            ...
            <motion.div
              ...
              className="px-1"
            >
              <ChevronDown size={16} className="text-indigo-600 dark:text-indigo-400 cursor-pointer" strokeWidth={3} />
            </motion.div>
          </button>
            ...
            {isDropdownOpen && (
              <>
                ...
                <motion.div
                  ...
                  className="absolute cursor-pointer right-0 mt-3 w-52 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-[20px] shadow-2xl z-20 py-2 overflow-hidden origin-top-right"
                >
                  ...
                  <div className="px-2 space-y-1">
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-3 rounded-xl text-xs font-bold cursor-pointer transition-colors ${role === "admin" ? "bg-indigo-50 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-400" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"}`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-3 rounded-xl text-xs font-bold cursor-pointer transition-colors ${role === "viewer" ? "bg-amber-50 dark:bg-amber-900/40 text-amber-700 dark:text-amber-400" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"}`}
                    >
